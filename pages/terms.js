...
const Terms = () => {
  ...
  <div className="text-black-600 mx-2 md:mx-10 my-2 py-24">
    ...
    <p className="px-10 py-2">
      ...
      of Codeswear&#39s Website, located at www.codeswear.com. By accessing this
      website we assume you accept these terms and conditions. Do not continue
      to use codeswear.com if you do not agree to take all of the terms and
    ...
    <p className="px-10 py-2">
      We employ the use of cookies. By accessing codeswear.com, you agreed to
      use cookies in agreement with the Codeswear&#39s Privacy Policy. Most
    ...
    <p className="px-10 py-2">
      ...
      intellectual property rights for all material on codeswear.com. All
      intellectual property rights are reserved. You may access this from
      codeswear.com for your own personal use subjected to restrictions set in
    ...
    <p className="mx-10 my-2 ">
      ...
      opinions and information in certain areas of the website. Codeswear does
      ...
      Codeswear,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, Codeswear shall not be liable for the
      ...
      Comments on this website. Codeswear reserves the right to monitor all
    ...
    <div>
      ...
      <p className="mx-10 my-2">
        {" "}
        You hereby grant Codeswear a non-exclusive license to use, reproduce,
    ...
    <p className="px-10 py-2">
      ...
      hyperlink compensates the absence of Codeswear; and (d) the link is in the
      ...
      inform us by sending an e-mail to Codeswear. Please include your name,
    ...
    <div>
      ...
      <p className="ml-10 mt-4">
        No use of Codeswear&#39s logo or other artwork will be allowed for linking
