            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  {Object.keys(variants).includes("gray") &&
                    Object.keys(variants["gray"]).includes(size) && (
                      <button
                        ...
                        className={`border-2  ml-1 bg-gray-500 rounded-full w-6 h-6 focus:outline-none ${color === "gray" ? "border-black" : "border-gray-300"
                          }`}
                      ></button>
                    )}
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className=" flex mx-1 md:ml-8 text-white bg-pink-500 disabled:bg-pink-300 border-0 py-2 px-1 md:px-6 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Buy Now
                </button>
                <button
              ...
              <div className="flex items-center my-8">
                ...
                <Link href={'https://codeswear.nyc3.digitaloceanspaces.com/sizechart.png'} >
                  <img
